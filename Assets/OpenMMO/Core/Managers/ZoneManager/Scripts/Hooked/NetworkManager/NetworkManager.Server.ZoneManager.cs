...
namespace OpenMMO.Network
{
    ...
    public partial class NetworkManager
    {
        ...
        {
            // YAADM 0 - spawn scene on server called in OnStartServer()
            //TODO: add method below for when all 5 players are ready, to spawn an instance and teleport them there. (like in login)
